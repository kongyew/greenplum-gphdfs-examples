...
LOCATION ('gphdfs://sandbox-hdp:8020/data/gphdfs_examples/gphdfs_readtextsimple1.txt')
...
LOCATION ('gphdfs://sandbox-hdp:8020/data/gphdfs_examples/write/')
      FORMAT 'TEXT' (DELIMITER ',');
...
LOCATION ('gphdfs://sandbox-hdp:8020/data/gphdfs_examples/gphdfs_readtextsimple2.txt')
   FORMAT 'TEXT' (DELIMITER ',');
...
LOCATION ('gphdfs://sandbox-hdp:8020/data/gphdfs_examples/write2/')
...
LOCATION ('gphdfs://sandbox-hdp:8020/data/gphdfs_examples/gphdfs_readfoo.txt')
FORMAT 'TEXT' (DELIMITER ',');

DROP EXTERNAL TABLE IF EXISTS gphdfs_writefoo;
CREATE WRITABLE EXTERNAL TABLE gphdfs_writefoo
(i int, bar text) LOCATION ('gphdfs://sandbox-hdp:8020/data/gphdfs_examples/foo') FORMAT 'text' (delimiter '|' null 'null');


-- Example #4
DROP EXTERNAL TABLE IF EXISTS gphdfs_readjson;
CREATE EXTERNAL TABLE gphdfs_readjson(id text, json text)
LOCATION ('gphdfs://sandbox-hdp:8020/data/gphdfs_examples/json/json.txt')
FORMAT 'TEXT' (DELIMITER ',');

DROP EXTERNAL TABLE IF EXISTS gphdfs_writejson;
CREATE WRITABLE EXTERNAL TABLE gphdfs_writejson
(id text, json text) LOCATION ('gphdfs://sandbox-hdp:8020/data/gphdfs_examples/json/json.txt') FORMAT 'text' (delimiter '|' null 'null');
